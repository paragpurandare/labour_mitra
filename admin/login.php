...
<?php
      ...
      if(isset($_POST['submit'])){
        ...
        $user_search = " select * from login_tbl where user_id = '$user' ";
        ...
        if($user_count){
            ...
            $_SESSION['username'] = $user_pass['user_name'];
            $_SESSION['login'] = $user_pass['user_id'];
...
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html"><b>Labour</b>Mitra</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Owner Login</p>
