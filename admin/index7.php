          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../php/emp_details_insert.php" enctype="multipart/form-data" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Employee Name</label>
                        <input type="text" name="emp_nm" class="form-control" id="exampleInput1" placeholder="Enter Employee Name" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" id="exampleInput1" placeholder="Enter Phone Number" required>
                      </div>
                    </div>
                    <!-- /.card-body -->

                    <div class="card-footer">
                      <button type="submit" name="emp_details_submit" class="btn btn-primary">Submit</button>
                    </div>
                  </form>
                </div><!-- /.card-body -->
              </div>
                      ...
                      <div class="card-body table-responsive p-0" style="height: 300px;">
                        <table class="table table-head-fixed text-nowrap">
                          ...
                          <tbody>
                            ...
                            $selectquery = " select * from add_card_emp_login ";
                            ...
                            ?>
                              <tr>
                                ...
                                <td><a href="UpdateEmp.php?id=<?php echo $res['id']; ?>" title="delete"><i class="fa fa-edit"></i></a></td>
                                <td><a href="../deletePhp/emp_details_delete.php?id=<?php echo $res['id']; ?>" title="delete"><i class="fa fa-trash"></i></a></td>
                              </tr>
                            <?php
                            }
                            ?>
