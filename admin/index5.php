          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <form action="../php/medical_details_insert.php" enctype="multipart/form-data" method="post">
                        <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Medical Name</label>
                            <input type="text" name="medical_nm" class="form-control" id="exampleInput1" placeholder="Enter Medical Name" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="card-footer">
                            <button type="submit" name="medical_details_submit" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
                </div><!-- /.card-body -->
              </div>
                      ...
                      <div class="card-body table-responsive p-0" style="height: 300px;">
                        <table class="table table-head-fixed text-nowrap">
                          ...
                          <?php
                              ...
                              $selectquery = " select * from medical_users ";
                              ...
                              while ($res = mysqli_fetch_array($query)) {
                                ?>
                                <tr>
                                  <td><?php echo $res['medical_name']; ?></td>
                                  ...
                                  <td><a href="UpdateMedical.php?id=<?php echo $res['id']; ?>"  title="delete"><i class="fa fa-edit"></i></a></td>
                                  <td><a href="../deletePhp/medical_details_delete.php?id=<?php echo $res['id']; ?>"  title="delete"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                <?php
                              }
                            ?>
