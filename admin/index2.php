              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                          ...
                          $selectquery = " select * from booking_form_entry ";
                          ...
                          while ($res = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                              ...
                              <td><?php echo $res['taluka']; ?></td>
                              <td><?php echo $res['address']; ?></td>
                              <td><a href="../deletePhp/booking_form_delete.php?id=<?php echo $res['id']; ?>"  title="delete"><i class="fa fa-trash"></i></a></td>
                            </tr>
                            <?php
                          }
                       ?>
